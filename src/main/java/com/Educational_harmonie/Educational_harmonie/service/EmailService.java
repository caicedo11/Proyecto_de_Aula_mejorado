...
public class EmailService {
   ...
   // Reemplaza este método en tu EmailService.java
    public void enviarInvitacion(String correo, String codigo, String rol, int idCargo, int horasValidez) {
        SimpleMailMessage mensaje = new SimpleMailMessage();
        mensaje.setTo(correo);
        mensaje.setSubject("Invitación para registrarte en Educational Harmonie");
        
        // Aquí forzamos que viaje con puerto 8081 (usando baseUrl) e inyectamos los parámetros clave
        String urlRegistro = baseUrl + "/registro?codigo=" + codigo + "&email=" + correo + "&cargo=" + idCargo;

        mensaje.setText("Has sido invitado a registrarte en la plataforma.\n\n" +
                "Rol asignado: " + rol + "\n" +
                "Código de invitación: " + codigo + "\n" +
                "Enlace de registro: " + urlRegistro + "\n" +
