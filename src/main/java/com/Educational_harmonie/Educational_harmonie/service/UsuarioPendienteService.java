...
public class UsuarioPendienteService {
    ...
    public Usuario registrarUsuario(Usuario usuario) throws Exception {
        ...
        // 1. Validar que no exista ya el NOMBRE DE USUARIO (Debe ser único para hacer el login)
        if (usuarioRepository.findFirstByUsuario(usuario.getUsuario()).isPresent()) {
        ...
        // ====================================================================
        // OMITIDO: Se removió la validación findFirstByCorreo para permitir
        // que un mismo correo tenga cuentas con diferentes roles en el sistema.
        // ====================================================================
        
        System.out.println(">>> [DEBUG] Nombre de usuario disponible, procediendo a guardar");
    ...
    public Optional<Usuario> buscarPorUsuario(String username) {
        return usuarioRepository.findFirstByUsuario(username);
    }
